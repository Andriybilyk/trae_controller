...
bool slint_bridge_wifi_ap_ssid_copy(char *out, int32_t out_len);
uint64_t slint_bridge_wifi_last_got_ip_ms(void);
...
uint32_t slint_bridge_get_total_heap_bytes(void);
uint32_t slint_bridge_get_free_psram_bytes(void);
uint32_t slint_bridge_get_total_psram_bytes(void);
bool slint_bridge_get_chip_temp_c(float *out_c);
uint8_t slint_bridge_get_board_profile(void);
int32_t slint_bridge_get_display_width(void);
int32_t slint_bridge_get_display_height(void);
