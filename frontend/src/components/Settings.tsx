        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div>
              ...
              <div className={`h-[46px] rounded-lg border px-3 flex items-center font-mono text-sm ${remoteConfig.connected ? 'border-emerald-700 bg-emerald-900/20 text-emerald-300' : 'border-zinc-800 bg-black text-zinc-400'
                }`}>
